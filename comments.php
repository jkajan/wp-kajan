...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One comment on %2$s', '%1$s comments on %2$s', get_comments_number(), 'comments title', 'jointswp' ) ),
					number_format_i18n( get_comments_number() ),
					'<span class="lobster">&ldquo;' . get_the_title() . '&rdquo;</span>'
				);
			?>
		</h2>
	...
	<?php endif; ?>
	<?php comment_form(array('class_submit'=>'button primary')); ?>
</div><!-- #comments -->
